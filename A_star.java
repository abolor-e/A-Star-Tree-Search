...
class Node
{
	...
	public Node(String state_ID, int h)
	{
		...
		this.pathCost = 0;
		this.heuristic = h;
		this.evaluation_function = pathCost + heuristic;
	}
	...
	public Node(Node other)
	{
		...
		this.evaluation_function = other.evaluation_function;
	}
}
...
public class A_star
{
	...
	public static void main(String[] args)
	{
		...
		PriorityQueue<Node> queue = new PriorityQueue<>(new Comparator<Node>() {
			...
			{
				return Integer.compare(n1.evaluation_function, n2.evaluation_function);
			}
		...
		while (true)
		{
			...
			for (Action_result ar : reach)
			{
				...
				new_node.evaluation_function = new_node.heuristic + new_node.pathCost;
